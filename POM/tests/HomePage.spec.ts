...
test.describe("Home Page Tests", () => {
    ...
    test(`RF_16.008.02 |  Verify deleting freestyle project on project's page`, async ({
        ...
        await app.statusFreestyleProjectPage.clickDeleteProjectBtn();
        await app.statusFreestyleProjectPage.clickYesInDeleteDialog();
...
test.describe("US_15.001 | Footer > Jenkins version", () => {
    ...
    test("RF_15.001.05 | Verify Footer Dropdown Get Involved URL", async ({
        app,
    }: {
        app: App;
    }) => {
