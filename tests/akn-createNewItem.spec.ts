...
import { jenkinsData } from "../tests/testData/akn-jenkinsData";

test.describe("US_01.001 | New Item > Create a new item", () => {
	test("TC_01.001.30 | Verify new item creation", async ({ page }) => {
		...
		const job = await page.locator(".jenkins-table__link").getAttribute("href");
