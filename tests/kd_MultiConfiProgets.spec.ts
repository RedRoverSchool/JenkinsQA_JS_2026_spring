...
test.describe('US_02.001 | Freestyle Project Configuration > Enable or Disable the Project', () : void => {
    test('TC_02.001.08 | turn on disable option for project from the dropdown menu', async ({ haveMultiProject } : {haveMultiProject : Page}) =>{
