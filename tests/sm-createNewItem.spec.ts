...
test.describe("US_01.001 | New Item > Creatе a new item", () => {
    ...
    test("TC_01.001.35 | Successful item creation", async ({ page }: { page: Page }) => {
    ...
    test("TC_01.001.36 | Verify new item name for invalid characters and blank name", async ({ page }: { page: Page }) => {
