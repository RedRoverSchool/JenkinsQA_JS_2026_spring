...
export async function cleanData(request) {
    ...
    async function postPage(uri, body, crumb) {
    ...
    async function deleteJobs() {
        ...
        await deleteByLink("job/{name}/doDelete", getSubstringsFromPage(mainPage, 'href="job/', '/"'), getCrumbFromPage(mainPage));
    }
    async function deleteViews() {
        const mainPage = await getPage("");
        await deleteByLink("view/{name}/doDelete", getSubstringsFromPage(mainPage, 'href="/view/', '/"'), getCrumbFromPage(mainPage));
        const viewPage = await getPage("me/my-views/view/all/");
        await deleteByLink(`user/${USERNAME.toLowerCase()}/my-views/view/{name}/doDelete`, getSubstringsFromPage(viewPage, `href="/user/${USERNAME.toLowerCase()}/my-views/view/`, '/"'), getCrumbFromPage(viewPage));
    }
