import { test, expect } from "../tests/testFixtures/ov-folder.fixture";
test.describe("US_01.002 | New Item > Folder", () => {
    test("TC_01.002.04 | Access New Item Page from existing folder", async ({ page, existingFolderName }) => {
...
//# sourceMappingURL=ov-accessNewItemFromExistingFolder.spec.js.map