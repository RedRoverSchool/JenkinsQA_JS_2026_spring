...
test.describe("US_13.002 | Header > Global Search", () => {
    ...
    test("TC_13.002.01 | Verify search results appear", async ({ page }) => {
    ...
    test("TC_13.002.02 | Verify search with keywords", async ({ page }) => {
        await page.locator("[href*='newJob']").click();
    ...
    test("TC_13.002.03 | Verify long query", async ({ page }) => {
        await page.locator("#root-action-SearchAction").click();
    ...
    test("TC_13.002.04 | Verify different letter cases", async ({ page }) => {
        await page.locator("#root-action-SearchAction").click();
...
//# sourceMappingURL=ech-verifyGlobalSearch.spec.js.map