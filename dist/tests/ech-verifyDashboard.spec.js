...
test.describe("US_13.001 | Header > Navigate to Dashboard", () => {
    test("TC_13.001.01 | Verify Dashboard is visible", async ({ page }) => {
    ...
    test("TC_13.001.02 | Verify redirection to Dashboard and content visibility", async ({ page }) => {
...
//# sourceMappingURL=ech-verifyDashboard.spec.js.map