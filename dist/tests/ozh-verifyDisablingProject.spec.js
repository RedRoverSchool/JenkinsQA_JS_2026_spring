...
test.describe('US_02.001 | Freestyle Project Configuration > Enable or Disable the Project', () => {
    test('TC_02.001.01 | Verify that warning message appears after disabling the project', async ({ page, }) => {
        ...
        await saveBtn.click();
        await expect(page.locator('form[id="enable-project"]')).toContainText('This project is currently disabled');
    });
});
//# sourceMappingURL=ozh-verifyDisablingProject.spec.js.map