...
test.describe('US_02.003 | Freestyle Project Configuration > Configure SCM', () => {
    test('TC_02.003.01 | Verify error message when repository URL is invalid', async ({ page }) => {
        ...
        await expect(page.locator(ozhJenkinsLocators.repoUrlError)).toContainText(ozData.repoErrorMessage);
    });
});
//# sourceMappingURL=ozh-VerifyInvalidRepositoryURl.spec.js.map