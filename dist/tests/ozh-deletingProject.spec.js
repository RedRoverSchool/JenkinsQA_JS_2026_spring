...
import { ozData, createNewItem, ozhJenkinsLocators, projectSidePanelLocators, } from './testData/ozh-data';
test.describe('US_16.008 | Freestyle Project Management > Delete Project', () => {
    ...
    test('TC_16.008.01 | Verify deleting project via dropdown menu', async ({ page, }) => {
...
//# sourceMappingURL=ozh-deletingProject.spec.js.map