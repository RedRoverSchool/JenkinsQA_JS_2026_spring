...
test.describe("US_12.002 | Dashboard with the items > Sort and Filter Items", () => {
    ...
    test("TC_12.002.01 | Default Sorting by Name (A→Z)", async ({ page }) => {
    ...
    test("TC_12.002.02 | Persisted Sorting by Name Preference Is Applied on Dashboard Load", async ({ page }) => {
...
//# sourceMappingURL=tz-dasboardItemsSorting.spec.js.map