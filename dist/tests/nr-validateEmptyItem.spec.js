...
test.describe("US_01.001 | New Item > Create a new item", () => {
    test("ID: TC_01.001.08 |Validate Empty Item Name", async ({ page }) => {
        // Open New Item page
    ...
    test("ID: TC_01.001.31 | Validate Duplicate Item Name", async ({ page }) => {
        // Open New Item page
        await page.locator("#side-panel a[href$='newJob']").click();
...
//# sourceMappingURL=nr-validateEmptyItem.spec.js.map