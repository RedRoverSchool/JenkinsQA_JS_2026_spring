import { test, expect } from "../tests/testFixtures/ov-organizationFolder.fixtures";
test.describe("US_07.001 | Organization folder Configuration > Change General Settings", () => {
    test("TC_07.001.01 | Access the General Settings from Job Dropdown on the main Jenkins page", async ({ page, organizationFolderName }) => {
    ...
    test("TC_07.001.02 | Access the General Settings by clicking the job name in the project table", async ({ page, organizationFolderName }) => {
        await page.locator("span.jenkins-mobile-hide").click();
        const folderName = page.getByRole('link', { name: organizationFolderName });
    ...
    test("TC_07.001.03 | Access the General Settings from the project link", async ({ page, organizationFolderName }) => {
        await page.locator("span.jenkins-mobile-hide").click();
        const folderName = page.getByRole('link', { name: organizationFolderName });
        await folderName.click();
...
//# sourceMappingURL=ov-organizationFolderGeneralSettings.spec.js.map