...
test.describe("US_01.002 | New Item > Folder", () => {
    test("TC_01.002.16 | Create folder from Dashboard", async ({ page }) => {
        // Open New Item page
    ...
    test.describe("US_01.002 | New Item > Folder", () => {
        ...
        test("ID: TC_01.002.19 | Apply folder configuration", async ({ page }) => {
...
//# sourceMappingURL=nr-createFolder.spec.js.map