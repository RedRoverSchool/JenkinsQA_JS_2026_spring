...
test.describe("US_01.003 | New Item > Copy from", () => {
    test("TC_01.003.08 | Verify creating a new item by copying configuration from an existing item", async ({ page }) => {
...
//# sourceMappingURL=yv-verifyCreatingByCopying.spec.js.map