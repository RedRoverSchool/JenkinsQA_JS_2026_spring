...
test.describe("US_09.007 | Build history > Delete Build", () => {
    ...
    test("TC_09.007.01 |Delete build from drop-down", async ({ page }) => {
    ...
    test("TC_09.007.02 | Delete Build from Buildgs block", async ({ page }) => {
    ...
    test("TC_09.007.03 | Color of the 'delete' button", async ({ page }) => {
...
//# sourceMappingURL=ym-deleteBuild.spec.js.map