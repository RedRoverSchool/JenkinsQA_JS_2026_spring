...
test.describe('US_01.004 | New Item | Select an Item type', () => {
    test('TC_01.004.01 | Verify all required item types are available', async ({ page, }) => {
    ...
    test('TC_01.004.02 | Verify an item type is selectable', async ({ page }) => {
        await page.getByRole('link', { name: 'New Item' }).click();
...
//# sourceMappingURL=jdv-selectAnItemType.spec.js.map