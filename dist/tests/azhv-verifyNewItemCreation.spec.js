...
import { jenkinsData } from "./testData/azhv-data";
test.describe("US_01.001 | New Item > Create a new item", () => {
    test("TC_01.001.28 | Verify new item creation", async ({ page }) => {
...
//# sourceMappingURL=azhv-verifyNewItemCreation.spec.js.map