...
export class HomePage extends BasePage {
    ...
    projectTableRow = (itemName) => this.page.locator(`tr#job_${itemName}`);
    itemDropDown = () => this.page.locator(`div.jenkins-dropdown`);
    deleteProjectInDropdownBtn = (itemName) => this.itemDropDown().locator(`button[href*="job/${itemName}/doDelete"].jenkins-dropdown__item`);
    ...
    buildHistoryLink = () => this.page.getByRole("link", { name: "Build History" });
    // actions
    ...
    async clickDeleteProjectInDropdown(itemName) {
